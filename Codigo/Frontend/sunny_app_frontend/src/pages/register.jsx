...
export function Register(){
    ...
    return ( 
        ...
        <form id="form" className="flex flex-col items-center justify-center rounded shadow-lg p-8 mt-5" onSubmit={SendData}>
            <div className="flex flex-row">
                <div className="flex flex-col">
                    <label className="font-semibold text-yellow-500" htmlFor="usernameField">Username</label>
            ...
            <div className="flex flex-row">
                <div className="flex flex-col">
                    <label className="font-semibold mt-3 text-yellow-500" htmlFor="passwordField">Password</label>
                ...
                <div className="flex flex-col ml-7">
                    <label className="font-semibold mt-3 text-yellow-500" htmlFor="passwordField">Confirm Password</label>
            ...
            <button className="h-12 px-6 w-64 text-black bg-yellow-500 mt-8 rounded font-semibold  hover:text-orange-600 duration-300">Register</button>
            <a className="h-12 px-6 w-64 pt-3 text-black bg-orange-600 mt-4 rounded font-semibold hover:text-yellow-500 duration-300" href="/login">Login</a>
        </form>
    </main>
    )
}